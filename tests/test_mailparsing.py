...
class TestMailParsing(unittest.TestCase):
        ...
        expected = {
            ...
            'devices': [
                ...
                {'device_action': u'Leszerelendő',
                 ...
                 'device_type': u'INTEK-S50CX DVB-S2 MPEG4 SD SET TOP BOX'},
                {'device_action': u'Leszerelend\u0151',
                 'device_ownership': u'B\xe9relt',
                 'device_sn': u'020632431142',
                 'device_type': u'CONAX SMART CARD (DVB-S MT)'},
                {'device_action': u'Leszerelend\u0151',
                 'device_ownership': u'B\xe9relt',
                 'device_sn': u'020632431126',
                 'device_type': u'CONAX SMART CARD (DVB-S MT)'},
                {'device_action': u'Leszerelend\u0151',
                 'device_ownership': u'B\xe9relt',
                 'device_sn': u'020632431134',
                 'device_type': u'CONAX SMART CARD (DVB-S MT)'},
                {'device_action': u'Leszerelend\u0151',
                 'device_ownership': u'B\xe9relt',
                 'device_sn': u'020632431142',
    ...
    def test_file16(self):
        ...
        expected = {
            ...
            'devices': [{'device_action': u'Felszerelend\xf5',
                         'device_sn': u'00912033306224',
    ...
    def test_file40(self):
        ...
        expected = {
            ...
            'devices': [
                ...
                {'device_action': u'Leszerelend\u0151',
                 'device_ownership': u'B\xe9relt',
                 'device_sn': u'014786919929',
                 'device_type': u'CONAX SMART CARD (DVB-S MT)'},
                {'device_action': u'Leszerelend\u0151',
                 'device_ownership': u'B\xe9relt',
                 'device_sn': u'014786972167',
                 'device_type': u'CONAX SMART CARD (DVB-S MT)'},
                {'device_action': u'Leszerelend\u0151',
                 'device_ownership': u'B\xe9relt',
                 'device_sn': u'014786920059',
                 'device_type': u'CONAX SMART CARD (DVB-S MT)'}],
            'house_num': u'2',
            'mt_id': u'474831361',
        ...
        expected = {
            ...
            'devices': [
                {'device_sn': u'CJZA03919102559',
                 'device_type': u'ADB-5800S -HD AVC DVB-S SET TOP BOX (MT)'},
                {'device_sn': u'014786974189',
                 'device_type': u'CONAX SMART CARD (DVB-S MT)'},
                {'device_sn': u'CJZA03919102560',
                 'device_type': u'ADB-5800S -HD AVC DVB-S SET TOP BOX (MT)'},
                {'device_sn': u'014786974171',
                 'device_type': u'CONAX SMART CARD (DVB-S MT)'},
                {'device_sn': u'CJZA03919102562',
                 'device_type': u'ADB-5800S -HD AVC DVB-S SET TOP BOX (MT)'},
                {'device_sn': u'014786974197',
                 'device_type': u'CONAX SMART CARD (DVB-S MT)'}],
            'house_num': u'32',
            'mt_id': u'482898501',
